        ...
        <div class="p-4 border-2 border-gray-600 rounded-lg w-auto">
            ...
            <table>
                <tr>
                    <td>Nama</td>
                    <td class="pl-2">: </td>
                    <td class="pl-2">${formResult.name}</td>
                </tr>
                <tr>
                    <td>Sanguinis</td>
                    <td class="pl-2">: </td>
                    <td class="pl-2">${formResult.sanguine}</td>
                </tr>
                <tr>
                    <td>Koleris</td>
                    <td class="pl-2">: </td>
                    <td class="pl-2">${formResult.choleric}</td>
                </tr>
                <tr>
                    <td>Melankolis</td>
                    <td class="pl-2">: </td>
                    <td class="pl-2">${formResult.melancholic}</td>
                </tr>
                <tr>
                    <td>Plegmatis</td>
                    <td class="pl-2">: </td>
                    <td class="pl-2">${formResult.phlegmatic}</td>
                </tr>
            </table>
        </div>
    `;
